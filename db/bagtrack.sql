...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230919085635_7ef315edb6b5c2db6a6f')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230919085635_7ef315edb6b5c2db6a6f')
BEGIN
    CREATE INDEX [IX_Flight_Date] ON [Flight] ([Date]);
END;
GO
...
BEGIN
    ...
    VALUES (N'20230919085635_7ef315edb6b5c2db6a6f', N'7.0.11');
END;
GO
